...
test.describe('Member Registration Flow', () => {
  ...
  test('should search and filter members', async ({ page }) => {
    ...
    if (await searchField.isVisible()) {
      ...
      await expect(
        page.locator('table tbody tr, [data-testid="user-card"], .user-item')
...
test.describe('Calendar Events Flow', () => {
  ...
  test('should display calendar', async ({ page }) => {
    ...
    const calendarElement = page.locator(
      '.calendar, [class*="calendar"], [data-testid="calendar"]'
    );
...
test.describe('Responsive Design Tests', () => {
  test('should display mobile menu on small screens', async ({ page }) => {
    ...
    const hamburgerMenu = page.locator(
      '[data-testid="mobile-menu"], [class*="hamburger"], button[aria-label*="menu"]'
    );
