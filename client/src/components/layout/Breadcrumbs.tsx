...
export const Breadcrumbs = () => {
  ...
  const breadcrumbs: BreadcrumbItem[] = [{ label: 'Início', path: '/dashboard' }];
  ...
  return (
    <nav aria-label="Breadcrumb" className="flex items-center space-x-1 text-sm text-muted-foreground px-4 py-2 bg-background/50 border-b">
