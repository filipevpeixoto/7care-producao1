...
const getInterestedSituationValue = (value: LocalUser) =>
  value.interestedSituation ||
  (value as { interested_situation?: string }).interested_situation ||
  '';
...
export const UserCardResponsive = memo(
  ({
    ...
    const [selectedSituation, setSelectedSituation] = useState(
      getInterestedSituationValue(localUser)
    );
                ...
                <Badge
                  ...
                  style={
                    selectedSituation
                      ? {
                          backgroundColor: `${
                            situationLevels.find((level) => level.value === selectedSituation)
                              ?.color
                          }20`,
