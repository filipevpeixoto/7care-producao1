...
export const ResponsiveStatsBadges: React.FC<ResponsiveStatsBadgesProps> = ({
  ...
  return (
    <>
      <Badge
        className={`group relative cursor-pointer transition-all duration-300 ease-out transform hover:scale-105 hover:shadow-lg text-[10px] sm:text-sm px-1.5 sm:px-3 py-1 sm:py-1.5 border-0 ${
          roleFilter === 'superadmin' || roleFilter === 'pastor'
            ? 'bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg shadow-blue-500/25'
            : 'bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 hover:from-blue-100 hover:to-blue-200 dark:from-blue-950 dark:to-blue-900 dark:text-blue-200 dark:hover:from-blue-900 dark:hover:to-blue-800'
        }`}
        onClick={() => {
      ...
      <Badge
        className={`group relative cursor-pointer transition-all duration-300 ease-out transform hover:scale-105 hover:shadow-lg text-[10px] sm:text-sm px-1.5 sm:px-3 py-1 sm:py-1.5 border-0 ${
          roleFilter === 'member'
            ...
            : 'bg-gradient-to-r from-emerald-50 to-emerald-100 text-emerald-700 hover:from-emerald-100 hover:to-emerald-200 dark:from-emerald-950 dark:to-emerald-900 dark:text-emerald-200 dark:hover:from-emerald-900 dark:hover:to-emerald-800'
        }`}
      ...
      <Badge
        className={`group relative cursor-pointer transition-all duration-300 ease-out transform hover:scale-105 hover:shadow-lg text-[10px] sm:text-sm px-1.5 sm:px-3 py-1 sm:py-1.5 border-0 ${
          roleFilter === 'missionary'
            ...
            : 'bg-gradient-to-r from-violet-50 to-violet-100 text-violet-700 hover:from-violet-100 hover:to-violet-200 dark:from-violet-950 dark:to-violet-900 dark:text-violet-200 dark:hover:from-violet-900 dark:hover:to-violet-800'
        }`}
      ...
      <Badge
        className={`group relative cursor-pointer transition-all duration-300 ease-out transform hover:scale-105 hover:shadow-lg text-[10px] sm:text-sm px-1.5 sm:px-3 py-1 sm:py-1.5 border-0 ${
          roleFilter === 'interested'
            ...
            : 'bg-gradient-to-r from-amber-50 to-amber-100 text-amber-700 hover:from-amber-100 hover:to-amber-200 dark:from-amber-950 dark:to-amber-900 dark:text-amber-200 dark:hover:from-amber-900 dark:hover:to-amber-800'
        }`}
