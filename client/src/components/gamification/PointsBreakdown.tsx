...
export const PointsBreakdown = ({ userData, breakdown, showDetails = true }: PointsBreakdownProps) => {
  ...
  const calculateCategoryPoints = (categoryName: string): number => {
    ...
    if (breakdown) {
      switch (categoryName) {
        case 'Engajamento': return breakdown.engajamento || 0;
        case 'Classificação': return breakdown.classificacao || 0;
        case 'Dizimista': return breakdown.dizimista || 0;
        case 'Ofertante': return breakdown.ofertante || 0;
        case 'Tempo de Batismo': return breakdown.tempoBatismo || 0;
        case 'Cargos': return breakdown.cargos || 0;
        case 'Nome da Unidade': return breakdown.nomeUnidade || 0;
        case 'Tem Lição': return breakdown.temLicao || 0;
        case 'Total de Presença': return breakdown.totalPresenca || 0;
        case 'Batizou Alguém': return breakdown.batizouAlguem || 0;
        case 'CPF Válido': return breakdown.cpfValido || 0;
        case 'Campos Vazios ACMS': return breakdown.camposVaziosACMS || 0;
        default: return 0;
      }
    }
  ...
  const calculateEscolaSabatinaPoints = (categoryName: string): number => {
    ...
    if (breakdown) {
      switch (categoryName) {
        case 'comunhao': return breakdown.comunhao || 0;
        case 'missao': return breakdown.missao || 0;
        case 'estudoBiblico': return breakdown.estudoBiblico || 0;
        case 'batizouAlguem': return breakdown.batizouAlguem || 0;
        case 'discipuladoPosBatismo': return breakdown.discipuladoPosBatismo || 0;
        default: return 0;
      }
    }
