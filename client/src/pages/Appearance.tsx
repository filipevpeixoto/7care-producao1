...
export default function Appearance() {
  ...
  const save = () => {
    const event = new CustomEvent('mobileHeaderLayoutUpdated', {
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <input
                        ...
                        onChange={e => update('logo', 'offsetX', parseInt(e.target.value))}
                        className="w-full"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={e => update('logo', 'offsetY', parseInt(e.target.value))}
                        className="w-full"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <input
                        ...
                        onChange={e => update('welcome', 'offsetX', parseInt(e.target.value))}
                        className="w-full"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={e => update('welcome', 'offsetY', parseInt(e.target.value))}
                        className="w-full"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <input
                        ...
                        onChange={e => update('actions', 'offsetX', parseInt(e.target.value))}
                        className="w-full"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={e => update('actions', 'offsetY', parseInt(e.target.value))}
                        className="w-full"
                      />
                    </div>
                  </div>
