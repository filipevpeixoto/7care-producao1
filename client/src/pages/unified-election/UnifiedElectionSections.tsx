...
export const DashboardTab = ({
  ...
  <div className="space-y-4">
    <div className="flex justify-between items-center">
      ...
      <Button onClick={() => navigate('/election-config')} className="bg-blue-600 hover:bg-blue-700">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {config.status === 'active' && (
                    <>
                      ...
                      <Button size="sm" variant="outline" onClick={() => navigate(`/election-config?id=${config.id}`)}>
                  ...
                  {config.status === 'draft' && (
                    <>
                      <Button size="sm" onClick={() => handleStartElection(config.id)} className="bg-green-600 hover:bg-green-700">
...
export const VotingTab = ({ activeElections, user, formatDate, handleAccessElection }: VotingTabProps) => (
  <div className="space-y-4">
        ...
        {activeElections.map(election => (
          <Card key={election.election_id} className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => handleAccessElection(election)} className="w-full bg-blue-600 hover:bg-blue-700" size="lg">
  ...
  <div className="space-y-4">
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <Button onClick={() => navigate('/election-dashboard')} className="w-full" variant="outline">
